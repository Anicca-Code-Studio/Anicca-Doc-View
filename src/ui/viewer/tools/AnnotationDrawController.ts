...
const DRAW_CURSOR_CLASS = "adv-viewer--tool-draw";
...
export function createAnnotationDrawController(options: AnnotationDrawControllerOptions) {
    ...
    function createPreviewLayer(): void {
        ...
        previewLayer.className = "adv-annotation-draw-preview";
    ...
    function beginDrawOnSlot(e: PointerEvent): Point | null {
        ...
        drawSlot = slotEl;
        drawAnnotationLayer = slotEl.querySelector<HTMLElement>(".adv-spread__annotation-layer");
        drawSubTool = tool;
    ...
    document.addEventListener("adv-finish-drawing", onFinishDrawing);
    ...
    function destroy(): void {
        unsub();
        document.removeEventListener("adv-finish-drawing", onFinishDrawing);
        deactivate();
    }
