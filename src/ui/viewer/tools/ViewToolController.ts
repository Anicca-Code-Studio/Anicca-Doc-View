...
const CURSOR_CLASSES: Record<string, string> = {
    pointer: "",
    hand: "adv-viewer--tool-hand",
    zoom: "adv-viewer--tool-zoom",
};

const HAND_GRABBING_CLASS = "adv-viewer--tool-hand-grabbing";
...
export function createViewToolController(options: ViewToolControllerOptions) {
    ...
    function attachZoomTool(): () => void {
        const ZOOM_OUT_CLASS = "adv-viewer--tool-zoom-out";
