...
const SELECT_CURSOR_CLASS = "adv-viewer--tool-select";
const MOVING_CLASS = "adv-viewer--annotation-moving";
const RESIZING_CLASS = "adv-viewer--annotation-resizing";
const BBOX_CLASS = "adv-annotation-select-bbox";
...
export function createAnnotationSelectController(options: AnnotationSelectControllerOptions) {
    ...
    function updateSelectionVisual(): void {
        ...
        if (!slot) return;
        const annotationLayer = slot.querySelector<HTMLElement>(".adv-spread__annotation-layer");
