...
export function renderHighlight(layer: HTMLElement, annotation: HighlightAnnotation, scale: number): HTMLElement {
    ...
    container.className = "adv-annotation adv-annotation--highlight";
...
export function renderUnderline(layer: HTMLElement, annotation: UnderlineAnnotation, scale: number): HTMLElement {
    const container = document.createElement("div");
    container.className = "adv-annotation adv-annotation--underline";
    container.style.position = "absolute";
    container.style.inset = "0";
    container.style.pointerEvents = "none";
...
export function renderStrikeOut(layer: HTMLElement, annotation: StrikeOutAnnotation, scale: number): HTMLElement {
    const container = document.createElement("div");
    container.className = "adv-annotation adv-annotation--strikeout";
    container.style.position = "absolute";
    container.style.inset = "0";
    container.style.pointerEvents = "none";
...
export function renderSquiggly(layer: HTMLElement, annotation: SquigglyAnnotation, scale: number): HTMLElement {
    const container = document.createElement("div");
    container.className = "adv-annotation adv-annotation--squiggly";
    container.style.position = "absolute";
    container.style.inset = "0";
    container.style.pointerEvents = "none";
...
function createQuadElement(
    ...
    el.className = "adv-annotation__quad";
...
function createUnderlineElement(
    ...
    const el = document.createElement("div");
    el.className = "adv-annotation__line";
...
function createSquigglyElement(
    ...
    const el = document.createElement("div");
    el.className = "adv-annotation__squiggly";
