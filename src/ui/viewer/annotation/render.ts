...
function createHighlightIndicator(bounds: Rect, scale: number): HTMLElement {
    ...
    el.className = "adv-annotation-highlight-indicator";
...
function createGenericAnnotation(layer: HTMLElement, annotation: Annotation, scale: number): HTMLElement {
    const el = document.createElement("div");
    el.className = `adv-annotation adv-annotation--${annotation.type}`;
        ...
        if (el) {
            ...
            if (highlightBounds && boundsMatch(annotation.bounds, highlightBounds)) {
                if (isFullLayerAnnotation(annotation.type) || isSvgBasedAnnotation(annotation.type)) {
                    ...
                    el.classList.add("adv-annotation--highlighted");
                }
            }
        }
    }
...
export function showAnnotationPopup(
    ...
    popup.className = "adv-annotation-popup";

    // Header with author and close button
    const header = document.createElement("div");
    header.className = "adv-annotation-popup__header";

    const author = document.createElement("span");
    author.className = "adv-annotation-popup__author";
    author.textContent = annotation.metadata?.author || "Note";
    header.appendChild(author);

    const closeBtn = document.createElement("button");
    closeBtn.className = "adv-annotation-popup__close";
    ...
    content.className = "adv-annotation-popup__content";
