...
export function createFloatingToolbar() {
    ...
    el.className = "adv-floating-toolbar";
    el.setAttribute("role", "toolbar");
    el.setAttribute("aria-label", "Page navigation and zoom");

    // Navigation section
    const navSection = document.createElement("div");
    navSection.className = "adv-toolbar__group";
    ...
    divider.className = "adv-toolbar__divider";

    // Zoom section
    const zoomSection = document.createElement("div");
    zoomSection.className = "adv-toolbar__group";
    ...
    zoomDropdownContainer.className = "adv-zoom-dropdown";
    ...
    function resetIdleTimer(): void {
        el.classList.remove("adv-floating-toolbar--idle");
        ...
        idleTimer = setTimeout(() => {
            ...
            el.classList.add("adv-floating-toolbar--idle");
        }, IDLE_TIMEOUT_MS);
    }
    ...
    function mount(container: HTMLElement, store: Store<ViewerState, Action>, i18n: I18n): void {
        ...
        rovingTabindex = setupRovingTabindex(el, ".adv-toolbar__btn, input");
