...
export function createNumberInput(config: NumberInputConfig): NumberInputInstance {
    ...
    panel.className = "adv-number-input-panel";
    panel.addEventListener("click", (e) => e.stopPropagation());

    const slider = document.createElement("input");
    slider.type = "range";
    slider.className = "adv-number-input-panel__slider";
    ...
    textInput.type = "text";
    textInput.className = "adv-number-input-panel__text";
    ...
    function isOpen(): boolean {
        return panel.classList.contains("adv-number-input-panel--open");
    }

    function open(anchorRect: DOMRect, containerRect: DOMRect): void {
        panel.style.left = `${anchorRect.left - containerRect.left}px`;
        panel.classList.add("adv-number-input-panel--open");
    }

    function close(): void {
        panel.classList.remove("adv-number-input-panel--open");
    }
