...
export function createSpread(
    ...
    function createSlotElement(pageNumber: PageSlot): PageSlotElement {
        ...
        container.className = "adv-spread__slot";
        ...
        if (pageNumber !== null) {
            ...
            const loadingTimer = setTimeout(() => {
                container.classList.add("adv-spread__slot--loading");
            }, 200);

            // Preview canvas (behind main canvas) — shows low-res preview while full-res renders
            const previewCanvas = document.createElement("canvas");
            previewCanvas.className = "adv-spread__preview-canvas";
            ...
            canvas.className = "adv-spread__canvas";
            ...
            textLayer.className = "adv-spread__text-layer";
            ...
            annotationLayer.className = "adv-spread__annotation-layer";
            ...
            searchHighlightLayer.className = "adv-spread__search-highlight-layer";
            ...
            customPageOverlayLayer.className = "adv-spread__custom-page-overlay-layer";
            ...
            let brandingHandle: BrandingHandle | null = null;
            {
                ...
                indicatorStyle.textContent = `
                    ...
                    .adv-viewer-dark .${textClass} {
                        color: #e2e8f0;
                    }
                    .adv-spread__slot:not(.adv-spread__slot--loading) .${indicatorClass} {
                        display: none;
                    }
                `;
        ...
        container.classList.add("adv-spread__slot--empty");
        return {
            container,
            canvas: null,
            previewCanvas: null,
                ...
                if (slotEl.previewRenderKey !== previewKey) {
                    workerClient
                        ...
                        .then((result) => {
                            ...
                            slotEl.container.classList.remove("adv-spread__slot--loading");
                        })
                        .catch(() => {
            ...
            for (let i = 0; i < matches.length; i++) {
                ...
                for (const rect of match.rects) {
                    ...
                    highlightEl.className = isActive
                        ? "adv-search-highlight adv-search-highlight--active"
                        : "adv-search-highlight";
