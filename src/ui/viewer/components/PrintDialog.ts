...
export function createPrintDialog() {
    ...
    overlay.className = "adv-print-overlay";
    overlay.style.display = "none";

    // Create dialog
    const dialog = document.createElement("div");
    dialog.className = "adv-print-dialog";
    dialog.setAttribute("role", "dialog");
    dialog.setAttribute("aria-labelledby", "adv-print-title");
    dialog.setAttribute("aria-modal", "true");

    dialog.innerHTML = `
        <h2 id="adv-print-title" class="adv-print-title">Print</h2>

        <div class="adv-print-section">
            <label class="adv-print-section-label">Pages</label>
            <div class="adv-print-radios">
                <label class="adv-print-radio">
                    <input type="radio" name="adv-print-range" value="all" checked>
                    <span>All pages</span>
                </label>
                <label class="adv-print-radio">
                    <input type="radio" name="adv-print-range" value="current">
                    <span>Current page (<span class="adv-print-current-page">1</span>)</span>
                </label>
                <label class="adv-print-radio">
                    <input type="radio" name="adv-print-range" value="fromTo">
                    <span>Pages</span>
                    <input type="number" class="adv-print-input adv-print-from" min="1" value="1" disabled aria-describedby="adv-print-error">
                    <span>to</span>
                    <input type="number" class="adv-print-input adv-print-to" min="1" value="1" disabled aria-describedby="adv-print-error">
                </label>
                <label class="adv-print-radio">
                    <input type="radio" name="adv-print-range" value="custom">
                    <span>Custom</span>
                    <input type="text" class="adv-print-input adv-print-custom" placeholder="e.g. 1,3,5-8" disabled aria-describedby="adv-print-error">
                </label>
            </div>
        </div>

        <div class="adv-print-section">
            <label class="adv-print-section-label" for="adv-print-quality">Quality</label>
            <select id="adv-print-quality" class="adv-print-select">
        ...
        <p class="adv-print-error" id="adv-print-error" aria-live="polite"></p>

        <div class="adv-print-actions">
            <button type="button" class="adv-print-btn adv-print-btn--cancel">Cancel</button>
            <button type="button" class="adv-print-btn adv-print-btn--print">Print</button>
        </div>
    `;
    ...
    // Query elements
    const radios = dialog.querySelectorAll<HTMLInputElement>('input[name="adv-print-range"]');
    const currentPageSpan = dialog.querySelector(".adv-print-current-page") as HTMLSpanElement;
    const fromInput = dialog.querySelector(".adv-print-from") as HTMLInputElement;
    const toInput = dialog.querySelector(".adv-print-to") as HTMLInputElement;
    const customInput = dialog.querySelector(".adv-print-custom") as HTMLInputElement;
    const qualitySelect = dialog.querySelector("#adv-print-quality") as HTMLSelectElement;
    const errorEl = dialog.querySelector(".adv-print-error") as HTMLParagraphElement;
    const cancelBtn = dialog.querySelector(".adv-print-btn--cancel") as HTMLButtonElement;
    const printBtn = dialog.querySelector(".adv-print-btn--print") as HTMLButtonElement;
    ...
    function mount(
        ...
        const titleEl = dialog.querySelector("#adv-print-title") as HTMLElement;
        if (titleEl) titleEl.textContent = i18n.t("print.title");

        const sectionLabels = dialog.querySelectorAll(".adv-print-section-label");
        ...
        const radioLabels = dialog.querySelectorAll(".adv-print-radio");
        // "All pages" radio
