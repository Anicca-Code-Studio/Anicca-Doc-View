...
export function createLoadingOverlay(showAttribution = true) {
    ...
    overlay.className = "adv-loading-overlay";
    ...
    content.className = "adv-loading-content";

    // Create spinner
    const spinner = document.createElement("div");
    spinner.className = "adv-loading-spinner";
    spinner.innerHTML = `
    ...
    progressContainer.className = "adv-loading-progress-container";

    // Create progress bar track
    const progressTrack = document.createElement("div");
    progressTrack.className = "adv-loading-progress-track";

    // Create progress bar fill
    const progressFill = document.createElement("div");
    progressFill.className = "adv-loading-progress-fill";
    ...
    progressText.className = "adv-loading-progress-text";
    ...
    function mount(container: HTMLElement, store: Store<ViewerState, Action>, i18n: I18n): void {
        ...
        unsubRender = store.subscribeRender((prev, next) => {
            ...
            if (next.isPrinting) {
                ...
                progressFill.classList.remove("adv-loading-progress-fill--indeterminate");
                ...
                progressFill.classList.add("adv-loading-progress-fill--indeterminate");
