...
export function createFontsPanel() {
    ...
    function renderEntries(entries: FontUsageEntry[]): void {
        ...
        for (const entry of entries) {
            ...
            item.className = "adv-fonts-panel__item";

            // Spec (what the document requested)
            const specEl = document.createElement("div");
            specEl.className = "adv-fonts-panel__spec";
            ...
            treeEl.className = "adv-fonts-panel__tree";
            ...
            for (const { info, primary } of allFonts) {
                ...
                row.className = `adv-fonts-panel__font-row${primary ? "" : " adv-fonts-panel__font-row--fallback"}`;

                const dot = document.createElement("span");
                dot.className = `adv-fonts-panel__dot${primary ? " adv-fonts-panel__dot--primary" : ""}`;
                row.appendChild(dot);

                const nameEl = document.createElement("span");
                nameEl.className = "adv-fonts-panel__font-name";
                let fontName =
                    info.familyName ||
                    info.postscriptName ||
                ...
                sourceEl.className = "adv-fonts-panel__source";
    ...
    function showLoading(): void {
        ...
        loading.className = "adv-fonts-panel__loading";
