...
export function createSearchPanel() {
    ...
    el.className = "adv-search-panel";

    // --- Header (input + case toggle) ---
    const header = document.createElement("div");
    header.className = "adv-search-panel__header";

    const inputWrapper = document.createElement("div");
    inputWrapper.className = "adv-search-panel__input-wrapper";

    const inputIcon = document.createElement("span");
    inputIcon.className = "adv-search-panel__input-icon";
    inputIcon.innerHTML = ICON_SEARCH;

    const input = document.createElement("input");
    input.className = "adv-search-panel__input";
    input.type = "text";
    input.placeholder = "Search in document...";
    input.setAttribute("aria-label", "Search text");

    const clearBtn = document.createElement("button");
    clearBtn.className = "adv-search-panel__clear";
    ...
    caseBtn.className = "adv-search-panel__case";
    ...
    fuzzyBtn.className = "adv-search-panel__fuzzy";
    ...
    nav.className = "adv-search-panel__nav";

    const status = document.createElement("span");
    status.className = "adv-search-panel__status";
    status.setAttribute("role", "status");
    status.setAttribute("aria-live", "polite");

    const navButtons = document.createElement("div");
    navButtons.className = "adv-search-panel__nav-buttons";

    const prevBtn = document.createElement("button");
    prevBtn.className = "adv-search-panel__nav-btn";
    prevBtn.innerHTML = ICON_CHEVRON_UP;
    prevBtn.title = "Previous match (Shift+Enter)";
    prevBtn.setAttribute("aria-label", "Previous match");

    const nextBtn = document.createElement("button");
    nextBtn.className = "adv-search-panel__nav-btn";
    ...
    results.className = "adv-search-panel__results";
    ...
    function applyState(slice: SearchPanelSlice): void {
        ...
        // Update case button
        caseBtn.classList.toggle("adv-search-panel__case--active", slice.caseSensitive);
        caseBtn.setAttribute("aria-pressed", String(slice.caseSensitive));

        // Update fuzzy button
        fuzzyBtn.classList.toggle("adv-search-panel__fuzzy--active", slice.fuzzy);
    ...
    function createResultItem(match: SearchMatch, globalIndex: number): HTMLDivElement {
        ...
        item.className = "adv-search-result";
        item.setAttribute("role", "option");
        item.dataset.matchIndex = String(globalIndex);

        const contextEl = document.createElement("span");
        contextEl.className = "adv-search-result__context";
        ...
        matchSpan.className = "adv-search-result__match";
    ...
    function appendResultItems(matches: SearchMatch[], fromIndex: number): void {
        for (let i = fromIndex; i < matches.length; i++) {
            ...
            if (match.pageIndex !== lastRenderedPage) {
                ...
                pageHeader.className = "adv-search-result__page-header";
    ...
    function updateActiveResult(activeIndex: number): void {
        const prev = results.querySelector(".adv-search-result--active");
        if (prev) {
            prev.classList.remove("adv-search-result--active");
        ...
        if (activeIndex >= 0) {
            ...
            if (active) {
                active.classList.add("adv-search-result--active");
