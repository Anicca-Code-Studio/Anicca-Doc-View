...
export function createRightPanel() {
    ...
    el.className = "adv-right-panel";

    // Resize handle (on left edge for right panel)
    const resizeHandle = document.createElement("div");
    resizeHandle.className = "adv-right-panel__resize-handle";
    ...
    content.className = "adv-right-panel__content";
    ...
    function applyState(slice: RightPanelSlice): void {
        ...
        el.classList.toggle("adv-right-panel--closed", !slice.open);
    ...
    function setupResize(): void {
        ...
        const onPointerUp = () => {
            ...
            el.classList.remove("adv-right-panel--resizing");
        ...
        const onPointerDown = (e: PointerEvent) => {
            ...
            el.classList.add("adv-right-panel--resizing");
